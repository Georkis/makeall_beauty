...
class Blog
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=CategoryProduct::class, inversedBy="blogs")
    ...
    public function getLikeless(): ?int
    {
        return $this->likeless;
    }

    public function setLikeless(?int $likeless): self
    {
        $this->likeless = $likeless;
